...
**中文用户请查看**: [快速入门指南.md](./快速入门指南.md) | **Chinese users see**: [Quick Start Guide (Chinese)](./快速入门指南.md)
...
For convenience, automated run scripts are provided:
...
These scripts will automatically install dependencies, build the project, and start the demo server.
